      ...
      <div className="w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 border border-stone-200 shadow-xl text-left">
        <div className="text-center mb-8">
          ...
          <p className="text-stone-500 text-xs mt-1">
            Access your client growth dashboard & agency control center
          </p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                type="button"
                onClick={() => setEmail('eladigitalw@gmail.com')}
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-[11px] font-bold text-[#1E56A0] hover:underline"
              >
                Forgot Password?
              </button>
            </div>
